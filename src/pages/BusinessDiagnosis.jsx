...
/** 商家分层经营分析：通用表格组件，各视角均可复用 */
const tierRows = [
  { tier: "老商0投广", merchants: 1200, activeMerchants: 800, adMerchants: 0, adRevenue: "0万", penetration: "0%" },
  { tier: "老商低MR", merchants: 860, activeMerchants: 720, adMerchants: 180, adRevenue: "12.3万", penetration: "20.9%" },
  { tier: "常规新商活动", merchants: 450, activeMerchants: 380, adMerchants: 95, adRevenue: "8.6万", penetration: "25%" },
  { tier: "高GTV成熟商", merchants: 320, activeMerchants: 310, adMerchants: 280, adRevenue: "45.2万", penetration: "90.3%" },
  { tier: "新签及流失挽回", merchants: 280, activeMerchants: 120, adMerchants: 35, adRevenue: "3.1万", penetration: "29.2%" },
];

const MerchantTierTable = ({ title = "商家分层经营分析" }) => (
  <Card className="border-none shadow-sm bg-white">
    <CardHeader>
      <CardTitle className="text-base font-semibold text-gray-900 flex items-center gap-2">
        ...
        <TableBody>
          {tierRows.map((row) => (
            <TableRow key={row.tier}>
              <TableCell className="font-medium text-gray-800">{row.tier}</TableCell>
              <TableCell>{row.merchants}</TableCell>
              <TableCell>{row.activeMerchants}</TableCell>
              <TableCell>{row.adMerchants}</TableCell>
              <TableCell>{row.adRevenue}</TableCell>
                  ...
                  <TableRow key={detail.city}>
                    ...
                    <TableCell>
                      <Button
                        ...
                        onClick={() => {
                          setPushTarget({ name: detail.city, mis: "yangfujie", data: detail });
                ...
                <TableRow key={row.city}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      className="text-[#4080FF]"
                      onClick={() => {
                        setPushTarget({ name: row.city, mis: "yangfujie", data: row });
                        setPushDialogOpen(true);
                      }}
                    >
                      <Send className="w-3.5 h-3.5 mr-1" />
                ...
                <TableRow key={row.name}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      className="text-[#4080FF]"
                      onClick={() => {
                        setPushTarget({ name: row.name, mis: "yangfujie", data: row });
                        setPushDialogOpen(true);
                      }}
                    >
                      <Send className="w-3.5 h-3.5 mr-1" />
